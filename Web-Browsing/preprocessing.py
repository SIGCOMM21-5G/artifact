...
parser.add_argument('--data_path', type=str, default='raw_dataset', help='dataset directory path')
...
for (i, foldername) in enumerate(nameList):
    if not(os.path.exists(parentPath + foldername)):
        print("the current dataset is incomplete comparing with the Google Drive version " + parentPath + foldername+" didn't found")
        continue
