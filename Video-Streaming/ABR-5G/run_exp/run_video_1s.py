...
try:
	...
	if abr_algo == 'RL':
		...
		command = 'exec /usr/bin/python ../rl_server/mpc_server_1s.py ' + trace_file
	...
	elif abr_algo == 'intfMPC':
		url = 'http://' + ip + '/' + 'myindex_' + 'fastMPC' + '.html'
		command = 'exec /usr/bin/python ../rl_server/mpc_server_multi.py ' + trace_file
	elif abr_algo == 'intfMPC_no_overhead':
		url = 'http://' + ip + '/' + 'myindex_' + 'fastMPC' + '.html'
		command = 'exec /usr/bin/python ../rl_server/mpc_server_multi_oracle.py ' + trace_file
	elif abr_algo == 'truthrobustMPC':
		url = 'http://' + ip + '/' + 'myindex_' + 'robustMPC' + '.html'
		command = 'exec /usr/bin/python ../rl_server/robust_mpc_server_truth.py ' + trace_file
	elif abr_algo == 'MLpredMPC':
		url = 'http://' + ip + '/' + 'myindex_' + 'fastMPC' + '.html'
		command = 'exec /usr/bin/python ../rl_server/mpc_server_truth_MLpred.py ' + trace_file
	elif abr_algo == 'hmMPC':
		url = 'http://' + ip + '/' + 'myindex_' + 'fastMPC' + '.html'
		command = 'exec /usr/bin/python ../rl_server/mpc_server_truth_hm.py ' + trace_file		
	else:
