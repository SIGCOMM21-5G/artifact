...
PLOT_SAMPLES = 300
THROUGHPUT_PATH='../sim/cooked_traces/4g_trace_bus_0002.log'
...
trace_timestamp = np.array(trace_timestamp) - np.min(trace_timestamp)
...
ax2.plot(trace_timestamp[:158], throughput[:158])
